...
class DeckBuilder:
    ...
    def _initialize_commander_attributes(self) -> None:
        ...
        Uses builder_constants.py constants for default values.
        """
    ...
    def _determine_mono_color(self, color_identity: str) -> bool:
        ...
        """
        from .builder_constants import MONO_COLOR_MAP
    ...
    def _determine_dual_color(self, color_identity: str) -> bool:
        ...
        Returns:
            True if color identity was handled, False otherwise
        """
        from .builder_constants import DUAL_COLOR_MAP
    ...
    def _determine_tri_color(self, color_identity: str) -> bool:
        ...
        Returns:
            True if color identity was handled, False otherwise
        """
        from .builder_constants import TRI_COLOR_MAP
    ...
    def determine_themes(self) -> None:
        ...
        try:
            ...
            # Initialize self.weights from builder_constants
            from .builder_constants import THEME_WEIGHTS_DEFAULT
    ...
    def add_standard_non_basics(self):
        ...
        This method processes the STAPLE_LAND_CONDITIONS from builder_constants to add appropriate
